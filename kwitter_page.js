...
like_button = "<button calss='btn btn-warning' id="+firebase_message_id+" value="+like+" onclick='updateLike(this.id)'>";
...
function updateLike(message_id)
{
      ...
      firebase.database().ref(room_name).cild(message_id).update({
         like : updated_likes
      });
}
